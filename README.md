...
Stella avoids Java's enforced file-spam by essentially internally concatenating all source files during compilation, then automatically splitting the result into `.class` files.
